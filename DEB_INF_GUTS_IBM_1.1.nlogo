...
globals[
  ...
  init_host_pop  ; initial host population size
]
; ------------------------------------------------------------------------------------------------------------------------------------------
...
to setup
  ...
  create-snails init_host_pop                   ; turtles are created in the beginning
  ask  snails  [
...
### 12-6-19
> made initial host population size user defined (`init_host_pop`)     
